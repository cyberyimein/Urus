...
WORKFLOW_REFS: dict[str, str] = {
    RemoteDecisionIntent.INSTRUMENT_ARBITRATION.value: "urus-instrument-arbitration@1",
    RemoteDecisionIntent.GROUP_ARBITRATION.value: "urus-group-arbitration@1",
    RemoteDecisionIntent.INDICATOR_ATTENTION.value: "urus-indicator-review@1",
    RemoteDecisionIntent.STRATEGY_ATTENTION.value: "urus-strategy-review@1",
}
